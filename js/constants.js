...
// Styling Configuration for events/lessons
const STYLE_CONFIG = {
    HOLIDAY: {
        keywords: ['holiday_item', 'new_year_item', 'eid_item'],
        classes: "bg-teal-50/50 dark:bg-teal-900/20 border-teal-100 dark:border-teal-900/50"
    },
    LAB: {
        classes: "bg-rose-50/50 dark:bg-rose-900/20 border-rose-100 dark:border-rose-900/50"
    },
    CLINICAL: {
        classes: "bg-violet-50/50 dark:bg-violet-900/20 border-violet-100 dark:border-violet-900/50"
    },
    FREELANCE: {
        classes: "bg-slate-50/50 dark:bg-slate-900/50 border-slate-100 dark:border-slate-800 opacity-60"
    },
    LUNCH: {
        classes: "bg-amber-50/50 dark:bg-amber-900/10 border-amber-100 dark:border-amber-900/30 border-dashed opacity-80"
    }
};

const MENU_KEYWORDS = [
    { keys: ['çorba'], icon: 'fa-mug-hot', color: 'text-amber-500' },
    { keys: ['pilav', 'makarna'], icon: 'fa-bowl-rice', color: 'text-yellow-500' },
    { keys: ['tavuk', 'et', 'köfte', 'kebab'], icon: 'fa-drumstick-bite', color: 'text-rose-500' },
    { keys: ['tatlı', 'baklava', 'puding', 'helva'], icon: 'fa-cookie', color: 'text-pink-500' },
    { keys: ['salata', 'meyve', 'cacık'], icon: 'fa-leaf', color: 'text-green-500' },
    { keys: ['yoğurt', 'ayran'], icon: 'fa-bottle-water', color: 'text-blue-400' }
];
